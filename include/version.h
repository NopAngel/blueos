...
/* Helper to compare versions in code: #if BLUEOS_VERSION_CODE >=
 * KERNEL_VERSION(2,3,0) */
#define KERNEL_VERSION(a, b, c) (((a) << 16) + ((b) << 8) + (c))
#define BLUEOS_VERSION_CODE                                                    \
  KERNEL_VERSION(BLUEOS_MAJOR, BLUEOS_MINOR, BLUEOS_PATCH)
...
#define UTS_VERSION "#1 SMP PREEMPT 2026-06-05 19:00:16"
