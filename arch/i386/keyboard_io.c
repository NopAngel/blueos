...
/**
 * update_cursor: Mueve el cursor parpadeante del hardware
 */
void
update_cursor()
{
...
/**
 * arch_get_scancode: Lee del puerto de datos 0x60
 */
uint8_t
arch_get_scancode()
{
...
/**
 * arch_put_char: El motor de renderizado de texto para x86
 */
void
arch_put_char(char c, unsigned int color)
{
    uint16_t *video_mem = (uint16_t *)VIDEO_ADDRESS;
